    ...
    <div class="flex items-center justify-between px-4 py-4 md:px-6 md:py-7">
      ...
      <nav class="hidden md:flex items-center space-x-5">
        ...
        <div v-else class="flex items-center space-x-3">
          <span class="pr-4 border-r border-white/30 font-light text-sm"
            >Halo, {{ authStore.userFullName }}</span
          >
          ...
          <a
            @click="handleLogout"
            class="px-4 py-2 rounded-md bg-red-500 hover:bg-red-600 cursor-pointer transition font-semibold text-white shadow-sm"
            >Logout</a
          >
        </div>
      </nav>
